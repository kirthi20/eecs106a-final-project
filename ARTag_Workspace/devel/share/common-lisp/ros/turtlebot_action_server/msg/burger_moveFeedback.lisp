...
(cl:defmethod cl:initialize-instance :after ((m <burger_moveFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'burger_moveFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_action_server-msg:<burger_moveFeedback> is deprecated: use turtlebot_action_server-msg:burger_moveFeedback instead.")))

(cl:ensure-generic-function 'step_distance-val :lambda-list '(m))
(cl:defmethod step_distance-val ((m <burger_moveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_action_server-msg:step_distance-val is deprecated.  Use turtlebot_action_server-msg:step_distance instead.")
  (step_distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<burger_moveFeedback>)))
  ...
  "turtlebot_action_server/burger_moveFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'burger_moveFeedback)))
  "Returns string type for a message object of type 'burger_moveFeedback"
  "turtlebot_action_server/burger_moveFeedback")
